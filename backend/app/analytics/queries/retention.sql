...
cohorts AS (
    SELECT
        ...
        CASE
            WHEN CAST(:channel AS text) IS NULL THEN NULL
            ELSE u.acquisition_channel
...
LEFT JOIN retained r
 ...
 AND r.acquisition_channel
     IS NOT DISTINCT FROM g.acquisition_channel
